...
echo "=== 连接到 Multicode Server ==="
echo "服务器: $SERVER_URL"

# 配置 server URL
export MULTICODE_SERVER_URL=$SERVER_URL
...
echo "  export MULTICODE_SERVER_URL=$SERVER_URL"
echo "  multicode daemon start"
