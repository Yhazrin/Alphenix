...
echo "=== 连接到 Alphenix Server ==="
echo "服务器: $SERVER_URL"

# 配置 server URL
export ALPHENIX_SERVER_URL=$SERVER_URL
...
echo "  export ALPHENIX_SERVER_URL=$SERVER_URL"
echo "  alphenix daemon start"
