...
export function getMockRunDetailData() {
  ...
  const steps: RunStep[] = [
    ...
    createMockRunStep({
      ...
      tool_name: "Read",
      call_id: "call_1",
      tool_input: { path: "/d/project/alphenix/multica/apps/web/features/runs/components/step-card.tsx" },
    ...
    createMockRunStep({
      ...
      tool_name: "Edit",
      call_id: "call_2",
      tool_input: { path: "/d/project/alphenix/multica/apps/web/features/runs/components/step-card.tsx", action: "update" },
